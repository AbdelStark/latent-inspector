...
- [ ] T010 [P] [US1] Contract or regression test for [endpoint] in tests/contract/test_[name].py
- [ ] T011 [P] [US1] Integration test for [user journey] in tests/integration/test_[name].py
- [ ] T012 [P] [US1] Golden output, benchmark, or UX snapshot for [story surface] in tests/[location]/[name]
...
- [ ] T017 [US1] Add validation, error handling, and diagnostics
- [ ] T018 [US1] Add user-facing docs/help/output copy for story 1
...
- [ ] T019 [P] [US2] Contract or regression test for [endpoint] in tests/contract/test_[name].py
- [ ] T020 [P] [US2] Integration test for [user journey] in tests/integration/test_[name].py
- [ ] T021 [P] [US2] Benchmark, fixture, or UX snapshot for [story surface] in tests/[location]/[name]
...
- [ ] T025 [US2] Integrate with User Story 1 components and user guidance (if needed)
...
- [ ] T026 [P] [US3] Contract or regression test for [endpoint] in tests/contract/test_[name].py
- [ ] T027 [P] [US3] Integration test for [user journey] in tests/integration/test_[name].py
- [ ] T028 [P] [US3] Benchmark, fixture, or UX snapshot for [story surface] in tests/[location]/[name]
...
- [ ] TXXX [P] Documentation, quickstart, and example updates in docs/
- [ ] TXXX Refresh benchmarks, golden outputs, or regression fixtures
- [ ] TXXX CLI/help/report copy and visual polish pass
- [ ] TXXX Code cleanup and refactoring
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX [P] Additional unit and integration tests in tests/
- [ ] TXXX Reliability, error-handling, and observability hardening
- [ ] TXXX Run quickstart.md and release-surface validation
...
Task: "Contract or regression test for [endpoint] in tests/contract/test_[name].py"
Task: "Integration test for [user journey] in tests/integration/test_[name].py"
Task: "Golden output, benchmark, or UX snapshot for [story surface] in tests/[location]/[name]"
...
- Verify executable validation fails before implementing when feasible
- Commit after each task or logical group
- Stop at any checkpoint to validate story independently
- Avoid: vague tasks, same file conflicts, cross-story dependencies that break independence, or dropping constitutional quality work
